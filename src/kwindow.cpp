...
/** Default constructor. */
KWindow::KWindow(QString name, QWidget *parent, Qt::WFlags flags)
...
void
KWindow::setShortcut(QString shortcut, const char *slot)
{
...
QVariant
KWindow::getSetting(QString setting, QVariant defaultValue)
{
...
void
KWindow::saveSetting(QString prop, QVariant value)
{
...
void
KWindow::setVisible(bool visible)
{
  if (visible) {
