...
class HostCatcher {
    ...
    public:
         ...
         * caller must decrease dontDestroy when he don't use longer this host.
         */
        HostAddress * getHost(  );
	...
	int firstNotTried;
	int firstBad;
	int lastReturned; // index of last host returned by getHost()
	int lastOrdReturned; // index of last host returned by getHostOrdered()
        
        QVector<HostAddress *> *mHostVector;
