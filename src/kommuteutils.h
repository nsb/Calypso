 ...
 ***************************************************************************/
#ifndef KOMMUTEUTILS_H
#define KOMMUTEUTILS_H
...
{
public:
    // convert byte number to human readable sizes
    static QString convertSize( int );
    static QString convertSize( unsigned long );
