 ...
 * @author Jason Rohrer.
 */
class ChannelReceivingThread : public QThread {
    ...
    protected:
         ...
         *
         * Will check signature of message if specified in from address
         * and flags.
         *
         * @param inMessageID the unique ID of this message.
         *   Must be destroyed by caller.
         * @param inFromAddress the address that this message is from.
         *   Must be destroyed by caller.
         ...
         *   Must be destroyed by caller.
         */
        char *processFlags( char *inMessageID,
                            char *inFromAddress,
                            char *inOldFlags,
