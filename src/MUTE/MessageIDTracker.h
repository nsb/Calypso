...
class MessageIDTracker {
    ...
    public:
        ...
        /**
         * Checks if the global counter (used in unique IDs) has rolled over
         * (returned back to 0) since hasCounterRolledOver was last called.
         *
         * @return true if the counter has rolled over since the last call
         *   to hasCounterRolledOver, or false if it has not.
         */
        char hasCounterRolledOver();
