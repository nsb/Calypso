...
#include "MUTE/ChannelReceivingThreadManager.h"
 ...
 * @author Jason Rohrer
 */
class ConnectionMaintainer : public QThread {
    ...
    protected:
        ...
        KbLimiter *mOutboundMessagePerSecondLimiter;
        KbLimiter *mInboundMessagePerSecondLimiter;
        ...
        QMutex *mCurrentAttemptInfoLock;
