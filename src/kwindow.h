...
#ifndef _KOMMUTEWINDOW_H
#define _KOMMUTEWINDOW_H
...
public:
  /** Default constructor. */
  KWindow(QString name, QWidget *parent = 0, Qt::WFlags flags = 0);
  /** Destructor. */
  ~KWindow();
...
private:
  ...
  KSettings* _settings; /**< Object used to store window properties */
